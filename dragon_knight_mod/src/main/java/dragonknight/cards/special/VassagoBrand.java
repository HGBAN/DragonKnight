...
public class VassagoBrand extends CustomCard {
    public static final String ID = makeID("VassagoBrand");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if (!p.hasPower(VassagoBrandPower.POWER_ID))
            addToBot(new ApplyPowerAction(p, p, new VassagoBrandPower(p, p)));
    }
}
