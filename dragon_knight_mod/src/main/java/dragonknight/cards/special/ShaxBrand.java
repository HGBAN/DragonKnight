...
public class ShaxBrand extends CustomCard {
    public static final String ID = makeID("ShaxBrand");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if (!p.hasPower(ShaxBrandPower.POWER_ID)) {
            addToBot(new ApplyPowerAction(p, p, new ShaxBrandPower(p)));
        }
    }
}
