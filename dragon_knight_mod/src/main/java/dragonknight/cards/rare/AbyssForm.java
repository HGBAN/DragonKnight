...
public class AbyssForm extends CustomCard {
    public static final String ID = makeID("AbyssForm");
    ...
    public AbyssForm() {
        super(ID, NAME, imagePath("cards/power/AbyssForm.png"), COST, DESCRIPTION, TYPE,
